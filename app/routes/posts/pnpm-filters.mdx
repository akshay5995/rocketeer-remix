...
Say we go for an approach by usin [matrix](https://docs.github.com/en/actions/using-jobs/using-a-matrix-for-your-jobs) that runs these tests in parallel.
...
This article was for people who don't have the luxury of adding more 3rd party tools or try use the most out the tools they're handed.
